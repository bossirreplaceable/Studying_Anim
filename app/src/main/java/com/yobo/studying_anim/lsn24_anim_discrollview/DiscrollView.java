...
public class DiscrollView extends ScrollView {
    ...
    /**
     * 当View中所有子控件都被映射成xml后触发
     * 先获取到ScrollView中的自定义LinearLayout布局，在获取到Linearlayout
     * 中的第一个子View，然后将它的高度设置成全屏的高度
     */
    @Override
    ...
    /**
     * 在控件发生变化的时候调用，也就是ScrollView初始的时候调用一次。
     * 这里主要的目的是让第一个View 能占据全屏
     */
    @Override
